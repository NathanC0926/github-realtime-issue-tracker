...
**Iteration 1: TF-IDF + LightGBM/XGBoost**  
- Convert issue text to TF-IDF vectors.  
...
| Iteration 1                | TF-IDF                           | XGBoost/LightGBM                      | Fast, efficient                     |
...
### 5. Context & Dataset  
- GitHub issues integrating textual (issue titles/descriptions) and structured data (timestamps, labels, assignees).  
- Dataset obtained via BigQuery, cleaned/preprocessed manually.  

### 6. Code Resources  
- **ML Libraries:** `scikit-learn`, `XGBoost`, `LightGBM`, `CatBoost`, `PyTorch`, `Hugging Face`  
...
|-------------------|--------------------------------------------------------|------------------|
| Milestone 1       | Data extraction and preprocessing                      | Apr 10           |
| Milestone 2       | Baseline models trained (TF-IDF, CatBoost)             | Apr 10                               |
| Iteration 1       | TF-IDF + XGBoost/LightGBM                               | Apr 15                               |
| Iteration 2       | BERT embeddings + XGBoost/LightGBM                      | Apr 20                               |
| Iteration 3 (Opt.)| TabNet experimentation                                  | Apr 25                               |
